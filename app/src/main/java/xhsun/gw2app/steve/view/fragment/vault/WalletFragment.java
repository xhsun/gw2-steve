...
import xhsun.gw2app.steve.backend.util.support.vault.wallet.CurrencyListAdapter;
...
import xhsun.gw2app.steve.backend.util.task.vault.wallet.RetrieveWalletTask;
import xhsun.gw2app.steve.backend.util.task.vault.wallet.UpdateWalletTask;
...
public class WalletFragment extends Fragment implements AddAccountListener, FragmentInfoProvider {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		new RetrieveWalletTask(this).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR);
	...
	private void onListRefresh() {
		cancelTasks();
		new UpdateWalletTask(this).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR);
	}
