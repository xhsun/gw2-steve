 ...
 * @since 2017-05-01
 */
abstract class CurrencyViewHolder<T> extends RecyclerView.ViewHolder {
	...
	void fillCoins(long value, TextView gold, TextView silver, TextView copper) {
	...
	RelativeLayout.LayoutParams getCopperLayout(int margin, int size, int id, View view) {
