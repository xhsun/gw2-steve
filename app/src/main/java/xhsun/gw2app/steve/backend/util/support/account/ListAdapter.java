...
public class ListAdapter extends RecyclerView.Adapter<ListAdapter.AccountViewHolder> {
	...
	public ListAdapter(ListOnClickListener listener, @NonNull List<AccountModel> accounts, AccountWrapper wrapper) {
	 ...
	 */
	public void setData(@NonNull List<AccountModel> data) {
		accounts = data;
	 ...
	 */
	public void addData(@NonNull AccountModel data) {
		accounts.add(data);
	 ...
	 * @param data account info
	 */
	public void removeData(@NonNull AccountModel data) {
		int index;
	...
	class AccountViewHolder extends RecyclerView.ViewHolder {
		...
		protected void bind(AccountModel info) {
			data = info;
