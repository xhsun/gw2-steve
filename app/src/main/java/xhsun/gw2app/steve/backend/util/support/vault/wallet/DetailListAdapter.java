...
import xhsun.gw2app.steve.backend.util.items.vault.wallet.CurrencyViewHolder;
...
class DetailListAdapter extends RecyclerView.Adapter<DetailListAdapter.WalletViewHolder> {
	...
	DetailListAdapter(List<WalletModel> wallet) {
		this.wallet = wallet;
	}
	...
	class WalletViewHolder extends CurrencyViewHolder<WalletModel> {
		...
		@Override
		protected void bind(WalletModel info) {
		...
		@Override
		protected void parseCoins(WalletModel wallet) {
